public class Dummy {
    public String removeDuplicateLetters(String s) {
        ...
        // we create a counter and end the iteration once the suffix doesn't have each
        // unique character
        ...
        // the string
        // note that we have to get rid of further occurrences of s[pos] to ensure that
